    ...
    return (
        <div className='flex flex-col items-center justify-center min-h-screen bg-gray-300'>
            <div className='bg-gray-800 p-10 flex flex-col items-center justify-center'>
                <h3 className='text-3xl text-white'>Sign-up</h3>
                <h4 className='text-l text-gray-200'>Already have an account? Sign-in</h4>
                {
                ...
                <button
                    ...
                    type='Submit' onClick={signupHandler}>Register</button>
            </div>
        </div>
    )
}
